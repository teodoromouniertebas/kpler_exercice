...
We will use the `fuzzjoin` library to suggest matches between unmatched product names and known aliases using string similarity. This will help us categorize unmapped products into two groups, **likely valid products** and **invalid entries**.
...
# table of the likely valid products
